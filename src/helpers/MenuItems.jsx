...
export const MenuItems = [
    ...
    },
    {
        ...
        children: [
            ...
            { title: 'BackChecker Report', path: getDynamicPath('/campaign-list', 'backCheckerReport') },
            { title: 'BA Performance', path: getDynamicPath('/campaign-list', 'baPerformance') },
            { title: 'Sync History', path: getDynamicPath('/campaign-list', 'syncHistory') },
            { title: 'BA Attendance', path: getDynamicPath('/campaign-list', 'baAttendance') },
